...
// Setup is running from the installed location, which is no longer true.
  ...
  //   CLSID_OnDemandUserAppsClass should be ...Google\Update\DentalWingsUpdate.exe.
...
HRESULT SetupGoogleUpdate::InstallRegistryValues() {
  ...
  // be called before registering the COM servers because DentalWingsUpdate.exe needs
