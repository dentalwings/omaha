...
// command line is of the form "<install location>\DentalWingsUpdate.exe"
...
// Returns the version of DentalWingsUpdate.exe that is installed in the official
// location. Returns an empty CString if DentalWingsUpdate.exe is missing.
